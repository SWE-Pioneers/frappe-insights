...
const initialSummaryState = ref('')
watch(
	showDialog,
	(open) => {
		if (open) {
			initialSummaryState.value = getSummaryState()
		}
	},
	{ immediate: true },
)
...
const isDirty = computed(
	() => !!initialSummaryState.value && getSummaryState() !== initialSummaryState.value,
)
...
<template>
	<Dialog v-model:open="showDialog" size="2xl" title="Summarize" :dismissible="!isDirty">
